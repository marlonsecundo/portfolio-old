...
const Skills: React.FC = () => {
  return (
    <ViewWrapper className="flex w-full bg-base-200 rounded-tr-badge rounded-bl-badge overflow-clip shadow-md pl-0 pr-0">
      <ViewWrapper.TopSpace />

      <ViewWrapper.Padding className="flex flex-col">
      ...
      <div className="bg-base-300 flex flex-col pb-5">
